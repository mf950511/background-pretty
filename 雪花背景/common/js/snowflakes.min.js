...
!function (e, a) {
  ...
  function o(e, a) {
    return function (e) {
      ...
      var t = []
        ...
        , i = void 0;
      try {
        for (var o, r = e[Symbol.iterator](); !(n = (o = r.next()).done) && (t.push(o.value),
          !a || t.length !== a); n = !0)
          ;
      } catch (e) {
        l = !0,
  ...
  var a, t, i, r = function () {
    function s(e, a, t) {
      ...
      n || (r.zIndex = t.zIndex + 10 * this.size,
        r.opacity = f(this.size, t.minSize, t.maxSize, t.minOpacity, t.maxOpacity)),
        m(l, r),
        m(i, {
    ...
    , d = function () {
      function l(e) {
        ...
        for (var a = 0; a < this.params.count; a++)
          this._flakes.push(new r(n, this._height(), this.params))
      }
      return e(l, [{
        key: "destroy",
        value: function () {
        ...
        key: "_injectStyle",
        value: function (e, a) {
          return a || (a = document.createElement("style"),
        ...
        key: "_removeStyle",
        value: function () {
          --l._count <= 0 && (l._count = 0,
            l._mainStyleNode && (l._mainStyleNode.parentNode.removeChild(l._mainStyleNode),
              delete l._mainStyleNode)),
            this._animationStyleNode && (this._animationStyleNode.parentNode.removeChild(this._animationStyleNode),
              delete this._animationStyleNode),
            this._imagesStyleNode && (this._imagesStyleNode.parentNode.removeChild(this._imagesStyleNode),
        ...
        value: function () {
          var e, a = document.body, t = document.documentElement;
